function varargout = GUIDE3_export(varargin)
% GUIDE3_EXPORT MATLAB code for GUIDE3_export.fig
%      GUIDE3_EXPORT, by itself, creates a new GUIDE3_EXPORT or raises the existing
%      singleton*.
%
%      H = GUIDE3_EXPORT returns the handle to a new GUIDE3_EXPORT or the handle to
%      the existing singleton*.
%
%      GUIDE3_EXPORT('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUIDE3_EXPORT.M with the given input arguments.
%
%      GUIDE3_EXPORT('Property','Value',...) creates a new GUIDE3_EXPORT or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GUIDE3_export_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GUIDE3_export_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help GUIDE3_export

% Last Modified by GUIDE v2.5 14-Jun-2020 01:09:31

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GUIDE3_export_OpeningFcn, ...
                   'gui_OutputFcn',  @GUIDE3_export_OutputFcn, ...
                   'gui_LayoutFcn',  @GUIDE3_export_LayoutFcn, ...
                   'gui_Callback',   []);
...
% --- Executes just before GUIDE3_export is made visible.
function GUIDE3_export_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GUIDE3_export (see VARARGIN)

% Choose default command line output for GUIDE3_export
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes GUIDE3_export wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = GUIDE3_export_OutputFcn(hObject, eventdata, handles) 
...
function h1 = GUIDE3_export_LayoutFcn(policy)
...
appdata.GUIDEOptions = struct(...
    ...
    'syscolorfig', 1, ...
    'blocking', 0, ...
    'lastSavedFile', 'C:\Users\Геннадий\Documents\MATLAB\GUIDE3_export.m', ...
    'lastFilename', 'C:\Users\Геннадий\Documents\MATLAB\untitled.fig');
...
'PlotBoxAspectRatio',[0.972136222910217 1 0.972136222910217],...
...
'Color',[0 0 0],...
'ColorMode','auto',...
'Position',[0.500000577064077 1.00808823529412 0.5],...
'PositionMode','auto',...
'Interpreter','tex',...
...
'ColorMode','auto',...
'Position',[0.500000476837158 -0.0833333348096094 0],...
'PositionMode','auto',...
'Interpreter','tex',...
'InterpreterMode','auto',...
'Rotation',0,...
...
'Color',[0.15 0.15 0.15],...
'ColorMode','auto',...
'Position',[-0.101380044133294 0.500000476837158 0],...
'PositionMode','auto',...
'Interpreter','tex',...
'InterpreterMode','auto',...
'Rotation',90,...
...
'Color',[0 0 0],...
'ColorMode','auto',...
'Position',[0.500001788898638 1.00808823529412 0.5],...
'PositionMode','auto',...
'Interpreter','tex',...
'InterpreterMode','auto',...
'Rotation',0,...
...
'Position',[7 2 12 3],...
'Callback',@(hObject,eventdata)GUIDE3_export('pushbutton1_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'Tag','pushbutton1');
...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[33 2 12 3],...
'Callback',@(hObject,eventdata)GUIDE3_export('pushbutton2_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'DeleteFcn',blanks(0),...
...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[65 2 12 3],...
'Callback',@(hObject,eventdata)GUIDE3_export('pushbutton3_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'DeleteFcn',blanks(0),...
...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[91 2 12 3],...
'Callback',@(hObject,eventdata)GUIDE3_export('pushbutton4_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'DeleteFcn',blanks(0),...
...
elseif local_isInvokeHGCallback(gui_State, varargin{:})
    % GUIDE3_EXPORT('CALLBACK',hObject,eventData,handles,...)
    gui_Create = false;
else
    % GUIDE3_EXPORT(...)
